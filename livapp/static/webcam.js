...
window.webcam = {
	...
	swf_url: '/livapp/static/webcam.swf', // URI to webcam.swf movie (defaults to cwd)'webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '/livapp/static/shutter.mp3', // URI to shutter.mp3 sound'shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : '/livapp/static/shutter.mp3'; //this.shutter_url = url ? url : 'shutter.mp3';
	},
